        ...
        var data = [
            {
                label: 'Registrations',
                data: [
                    [moment().subtract(11, 'month').valueOf(), {{count(\App\Models\User::whereMonth('created_at', \Carbon\Carbon::now()->format('M')->subMonths(11))->whereYear('created_at', \Carbon\Carbon::now()->format('Y'))->get())}}],
