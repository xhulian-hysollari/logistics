...
@section('content')
    <div class="container block-content" style="padding-left: 20px; padding-right: 20px;">
                    ...
                    <div class="row">
                        <div>
                            ...
                            <p>
                                ...
                                <br/>
                                <i class="fa fa-phone"></i>{{$result->user->phone}}
                    ...
                    <div class="row">
                        <div>
                            ...
                            <p>
                                ...
                                <br/>
                                <i class="fa fa-phone"></i>{{$result->user->company->phone}}
                                <br/>
        ...
        <hr>
        <div class="row main-grid">
            {!! Form::model($bid = new \App\Models\Bid(), ['route' => ['bid.truck', $result->id, 1], 'method' => 'POST', 'class' => 'form-horizontal', 'novalidate']) !!}
