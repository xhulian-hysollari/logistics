...
<div class="container">
    <table style="margin-left: auto; margin-right: auto" width="550">
        <tr>
            <td>
                <strong><a href="https://maxlogistics.eu">maxlogistics.eu</a></strong>
            </td>
        ...
        <tr valign="top">
            ...
            <td>
                <br>
                <br>
                <strong>From:</strong> {{ $vendor }}
                <br>
                Ymer Kurti Street, <br> Tirana, <br> Albania<br>
                +355688400008<br>
                <a href="mailto:contact@maxlogistics.eu">contact@maxlogistics.eu</a>
            </td>
        </tr>
        <tr valign="top">
            <td colspan="2">
