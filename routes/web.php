        ...
        */
        ...
        Route::middleware(['lastKnight'])->group(function () {
            ...
            */
            ...
            Route::post('/freights/delete/{id}', ['as' => 'freight.delete', 'uses' => 'FreightController@destroy']);
            ...
            Route::post('/trucks/delete/{id}', ['as' => 'trucks.delete', 'uses' => 'TruckController@destroy']);
            ...
            */
            ...
            Route::post('/contracts/delete/{id}', ['as' => 'contracts.delete', 'uses' => 'ContractsController@destroy']);
...
//                Route::get('create', ['as' => 'messages.create', 'uses' => 'MessageController@create']);
                Route::post('{id?}/{receiver_id}', ['as' => 'messages.store', 'uses' => 'MessageController@store']);
                Route::get('{id}', ['as' => 'messages.show', 'uses' => 'MessageController@getConversation']);
